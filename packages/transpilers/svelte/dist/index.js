import { BaseTranspiler, indent, parseExpression, toPascalCase, isPureExpression, extractExpression } from '@awesomeui/transpiler-shared';

// src/svelte-transpiler.ts
var SvelteTranspiler = class extends BaseTranspiler {
  framework = "svelte";
