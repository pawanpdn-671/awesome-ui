...
var BaseTranspiler = class {
  ...
  transpile(input, options) {
    let ir;
    const validationResult = core.validateComponentIR(input);
    if (core.isOk(validationResult)) {
      ir = validationResult.data;
    } else {
      return core.err(validationResult.error);
    }
    const mergedOptions = {
      ...DEFAULT_OPTIONS,
      ...options
    ...
    try {
      ...
      return core.err(new core.ValidationError(`Transpilation failed: ${message}`, []));
    }
  }
  /**
...
exports.irTypeToTSBase = irTypeToTSBase;
exports.isExpression = isExpression;
exports.isPureExpression = isPureExpression;
exports.parseExpression = parseExpression;
exports.resolvePropsExpression = resolvePropsExpression;
exports.toCamelCase = toCamelCase;
exports.toPascalCase = toPascalCase;
exports.wrapInQuotes = wrapInQuotes;
exports.wrapInSingleQuotes = wrapInSingleQuotes;
