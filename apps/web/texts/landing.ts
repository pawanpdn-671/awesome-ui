...
export const hero = {
	...
	subtitle: "One design system. Unified APIs. Beautiful defaults.",
...
export const componentShowcase = {
	...
	subheading: "Explore our growing library of production-ready components. Every component works in every framework.",
	...
	components: [
		...
		},
		{
			id: "dialog",
			name: "Dialog",
			description: "Modal dialog with overlay, focus trap, and animations.",
			category: "Overlay",
		},
		{
			id: "form",
			name: "Forms",
			description: "Form components with validation, labels, and error states.",
			category: "Data Entry",
		},
		{
			id: "command",
		...
		},
		{
			id: "table",
			name: "Table",
			description: "Data table with sorting, pagination, and responsive design.",
	...
	preview: {
		...
		command: {
			...
			shortcut: "⌘K",
			items: ["Settings", "Profile", "Notifications", "Logout"],
		},
		card: {
			title: "Beautiful Card",
			description: "Cards are versatile content containers used throughout the UI.",
			cta: "Learn More",
		},
		table: {
			...
			rows: [
				...
				{ name: "Bob Johnson", role: "PM", status: "Away" },
			],
		},
	},
	...
	features: [
		{
			...
			desc: "Fully typed APIs with strict TypeScript support. Autocomplete works out of the box.",
		},
...
export const architectureSection = {
	...
	layers: [
		{
			title: "Core IR",
			desc: "Framework-agnostic Intermediate Representation defines every component as structured JSON.",
		},
		{
			title: "Framework Adapters",
			desc: "Thin adapters translate IR to React, Vue, Angular, Svelte, SolidJS, and React Native.",
		},
		{
			title: "Design Tokens",
			desc: "Shared design tokens drive consistent styling across every framework and platform.",
		},
		{
			title: "Accessibility Engine",
			desc: "Built-in WAI-ARIA patterns, keyboard navigation, and screen reader support.",
		},
		{
			title: "Rendering Layer",
			desc: "Optimized rendering with SSR, RSC, and streaming support for maximum performance.",
		},
		...
		steps: [
			{
				number: "1",
				title: "Define in IR",
				desc: "Components are defined in a framework-agnostic JSON format using our IR schema.",
			},
			{
				number: "2",
				title: "Transpile",
				desc: "Framework adapters transpile IR to native React, Vue, Angular, or Svelte components.",
			},
			{
				number: "3",
				title: "Render",
				desc: "Native components render with shared design tokens, theming, and accessibility built in.",
			},
		],
	},
} as const;
...
export const ecosystemSection = {
	...
	subheading: "A growing ecosystem of tools, integrations, and resources to accelerate your workflow.",
	items: [
...
export const comparisonSection = {
	...
	subheading: "The only truly cross-framework UI platform. No other library comes close.",
	headers: [
...
export const componentsPage = {
	...
	subheading: "Explore every AwesomeUI component. Each component works identically across all supported frameworks.",
} as const;
